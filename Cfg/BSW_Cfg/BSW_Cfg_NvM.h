...
#define BLOCK1_SPEED_LIMITING_QUICK_BREAKING_ADRESS (BLOCK1_EXTERNALCOORDINATION_ADRESS + BLOCK1_EXTERNALCOORDINATION_LEN)
#define BLOCK1_SPEED_LIMITING_QUICK_BREAKING_LEN     (9U)
#define BLOCK1_OVERCURRENT_PROTECTION_ADRESS (BLOCK1_SPEED_LIMITING_QUICK_BREAKING_ADRESS + BLOCK1_SPEED_LIMITING_QUICK_BREAKING_LEN)
#define BLOCK1_OVERCURRENT_PROTECTION_LEN     (9U)
#define BLOCK1_POWER_RECOVERY_ADRESS (BLOCK1_OVERCURRENT_PROTECTION_ADRESS + BLOCK1_OVERCURRENT_PROTECTION_LEN)
#define BLOCK1_POWER_RECOVERY_LEN     (9U)
