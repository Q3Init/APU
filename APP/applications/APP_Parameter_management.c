...
static APP_ProtectRte Protect_datasList[PROTECT_NUMS] = 
{
    ...
    {.id = Speed_limiting_quick_breaking, .protect_value = 0,.protect_default_value = 20.0f, .delay_tick = 0,.delay_default_tick = 0.2,.address = BLOCK1_SPEED_LIMITING_QUICK_BREAKING_ADRESS,    .eol = FALSE},
    {.id = Overcurrent_protection,        .protect_value = 0,.protect_default_value = 7.0f,  .delay_tick = 0,.delay_default_tick = 0.5,.address = BLOCK1_OVERCURRENT_PROTECTION_ADRESS,           .eol = FALSE},
    {.id = Power_recovery,                .protect_value = 0,.protect_default_value = 100.0f,.delay_tick = 0,.delay_default_tick = 1.0,.address = BLOCK1_OVERCURRENT_PROTECTION_ADRESS,           .eol = FALSE},
};
