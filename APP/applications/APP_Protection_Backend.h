...
// 电压换算系数
#define VOLTAGE_CONV_SCALE  (300*1000/20)
// 电流换算系数
#define CURRENT_CONV_SCALE  (2000/20)
/* ADC电路电压偏移 */
...
typedef struct {
    ...
    float32 harmonic_volt_distortion;  /* 电压失真度,三相中值 */
    ...
    float32 fundamental_freq;          /* 基波频率，单位：hz */
    ...
    float32 active_power_total;    /* 总有功功率，单位：W */
    float32 reactive_power_total;  /* 总无功功率：单位：var */
    float32 apparent_power_total;  /* 总视在功率，单位：va */
} APP_Calc_Value_t;
