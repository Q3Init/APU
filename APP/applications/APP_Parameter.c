...
void app_allpara_default_init( void )
{
    ...
    nvm_datas_Lists[ NUMBER42 ].dft                         = MCM_floatToIntBit( 0.2 );
    nvm_datas_Lists[ NUMBER43 ].dft                         = MCM_floatToIntBit( 0.2 );
    nvm_datas_Lists[ NUMBER44 ].dft                         = MCM_floatToIntBit( 0.2 );
    nvm_datas_Lists[ NUMBER45 ].dft                         = MCM_floatToIntBit( 0.2 );
    nvm_datas_Lists[ NUMBER46 ].dft                         = MCM_floatToIntBit( 0.2 );
    nvm_datas_Lists[ NUMBER47 ].dft                         = MCM_floatToIntBit( 0.2 );
