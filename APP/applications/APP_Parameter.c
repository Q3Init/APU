...
void app_allpara_default_init( void )
{
    ...
    nvm_datas_Lists[ NUMBER3 ].dft                          = MCM_floatToIntBit( 100 );
    nvm_datas_Lists[ NUMBER4 ].dft                          = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER5 ].dft                          = MCM_floatToIntBit( 100 );
    nvm_datas_Lists[ NUMBER6 ].dft                          = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER7 ].dft                          = MCM_floatToIntBit( 100 );
    nvm_datas_Lists[ NUMBER8 ].dft                          = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER9 ].dft                          = MCM_floatToIntBit( 100 );
    nvm_datas_Lists[ NUMBER10 ].dft                         = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER11 ].dft                         = MCM_floatToIntBit( 100 );
    nvm_datas_Lists[ NUMBER12 ].dft                         = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER13 ].dft                         = MCM_floatToIntBit( 100 );
    nvm_datas_Lists[ NUMBER14 ].dft                         = MCM_floatToIntBit( 5 );
    ...
    nvm_datas_Lists[ NUMBER41 ].dft                         = MCM_floatToIntBit( 100 );
    nvm_datas_Lists[ NUMBER42 ].dft                         = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER43 ].dft                         = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER44 ].dft                         = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER45 ].dft                         = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER46 ].dft                         = MCM_floatToIntBit( 5 );
    nvm_datas_Lists[ NUMBER47 ].dft                         = MCM_floatToIntBit( 5 );
...
void App_Uart1_Reinit( void )
{
    uint32 baudRate = app_par_Serial_baud_rate.datas;
    uint32 parity   = app_par_Serial_check.datas;
    MCAL_UART1_ReInit( baudRate, (USART_PARITY_T)parity );
}
