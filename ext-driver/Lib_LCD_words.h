...
extern uint8_t SAN_char[];
extern uint8_t SI_char[];
extern uint8_t WU_char[];
extern uint8_t LIU_char[];
extern uint8_t power_reverse_closing_first[];
extern uint8_t power_reverse_closing_second[];
extern uint8_t power_reverse_closing_third[];
extern uint8_t power_reverse_closing_fourth[];
extern uint8_t power_reverse_closing_fifth[];
